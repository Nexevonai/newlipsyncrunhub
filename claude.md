...
- **colormatch="mkl"**: Prevents gradual color/contrast increase in long videos (30+ seconds)

**File Reference:** `/test_pixaroma_44sec_4steps_colorfix.json`

### 🎯 Production-Ready Configuration (Tested & Proven)

**Tested durations:** 17s, 32s, 44s @ 1280×720 HD
**Hardware:** RTX 5090, 32GB VRAM
**Status:** Production-ready ✅

**Optimal Settings for Long Videos (30+ seconds):**

| Setting | Value | Why |
|---------|-------|-----|
| **Main Model** | Q5_0 | Best quality/speed balance |
| **InfiniteTalk** | Q8 | High-quality audio-driven animation |
| **LoRA** | rank64 @ 1.0 | Full effect, proven quality |
| **Steps** | **4** | Perfect quality, 33% faster than 6 steps |
| **colormatch** | **"mkl"** | CRITICAL for long videos - prevents color drift |
| **base_precision** | fp16_fast | Faster than bf16, no quality loss |
| **attention_mode** | sageattn | Flash Attention 2 optimization |
| **scheduler** | dpm++_sde | Stable for long durations |
| **motion_frame** | 25 | Smooth temporal coherence |

**Performance Benchmarks (RTX 5090):**

| Duration | Resolution | Steps | Settings | Gen Time | Quality | Notes |
|----------|-----------|-------|----------|----------|---------|-------|
| 17s | 1280×720 | 6 | All optimizations | ~20 min | Perfect ✅ | Baseline test |
| 44s | 1280×720 | 6 | No colorfix | ~50 min | Color drift ❌ | Gradual contrast increase |
| 44s | 1280×720 | 4 | **+ colorfix (mkl)** | **~30 min** | **Perfect ✅** | **Production config** |

**Key Findings:**
1. ✅ **4 steps is sufficient** with Q5_0 model - 6 steps does NOT improve quality
2. ✅ **colormatch="mkl" is CRITICAL** for videos >30 seconds - prevents gradual color/contrast drift
3. ✅ **30 minutes for 44 seconds** @ 1280×720 HD (proven production speed)
4. ✅ Q5_0 quality compensates for fewer steps vs Q4_0+6 steps

**When to use which config:**
- **Short videos (<20s)**: Can use `colormatch: "disabled"` (Pixaroma default)
- **Long videos (30s+)**: MUST use `colormatch: "mkl"` (prevents color drift)
- **Maximum speed**: 4 steps (proven quality with Q5_0)
- **Maximum quality**: Same 4 steps - more steps don't help with current settings
